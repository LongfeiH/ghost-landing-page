import { DecoratorNode, $getRoot, ElementNode } from 'lexical';
 ...
 */
function generateDecoratorNode(_ref) {
  let {
    nodeType,
    properties = [],
    version = 1
...
function renderHorizontalRuleNode(_) {
  let options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  addCreateDocumentOption(options);
  const document = options.createDocument();
...
function renderToggleNode(node) {
  let options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  addCreateDocumentOption(options);
  const document = options.createDocument();
...
function renderButtonNode(node) {
  let options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  addCreateDocumentOption(options);
  const document = options.createDocument();
...
function renderFileNode(node) {
  ...
  if (options.target === 'email') {
    ...
    return cardTemplate$3(node, document);
  }
}
...
function cardTemplate$3(node, document) {
...
function renderHeaderNodeV1(node) {
  let options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  addCreateDocumentOption(options);
  const document = options.createDocument();
...
function parseHeaderNodeV1(HeaderNode) {
  return {
    div: nodeElem => {
...
function renderHeaderNodeV2(dataset) {
  let options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  addCreateDocumentOption(options);
  const document = options.createDocument();
  const node = {
...
function renderProductNode(node) {
  let options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  addCreateDocumentOption(options);
  const document = options.createDocument();
  if (node.isEmpty()) {
...
function renderEmailCtaNode(node) {
  let options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  addCreateDocumentOption(options);
  const document = options.createDocument();
  const {
...
function renderSignupCardToDOM(dataset) {
  let options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  addCreateDocumentOption(options);
  const document = options.createDocument();
  const node = {
